---
title: "MM1S_KB528_timeseries_pipeline"
date: "09/21/2023"
...
#### This pipeline is used to process the log2FC data for the MM1S time series KB528 experiment. 
...
args <- c("","","","",
  WORKSHOPDIR,# 5
  file.path("./MM1S_timeseries_TPM.txt"), # 6
  file.path("KB528_time_series/"),# 7
  "KB528_MM1S_analysis",# 8         
  "ignore", # 9
  FALSE)# 10
...
annotation_key <- read.csv("./annotation_MM1S_timeseries.csv")
#### S8 had issues and was removed. 
annotation_key <- dplyr::filter(annotation_key,label != "S8")
...
annotation_key$rep <- c("Rep_1","Rep_2","Rep_3","Rep_1","Rep_2","Rep_3","Rep_1","Rep_2","Rep_1","Rep_2","Rep_3","Rep_1","Rep_2","Rep_3")
...
all_fpkm_exprs <- read.delim("./MM1S_KB528_timeseries_TPM.csv",sep = "\t")
all_fpkm_exprs$S8 <- NULL
